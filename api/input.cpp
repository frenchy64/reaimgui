...
{
  Callback<ImGuiInputTextCallbackData>::invoke(data);
  return 0;
}
...
template<>
void Callback<ImGuiInputTextCallbackData>::storeVars(Function *func)
{
...
template<>
void Callback<ImGuiInputTextCallbackData>::loadVars(const Function *func)
{
  if(s_data->EventFlag & ImGuiInputTextFlags_CallbackCharFilter)
...
"")
{
  if(Callback<ImGuiInputTextCallbackData>::DataAccess data {})
